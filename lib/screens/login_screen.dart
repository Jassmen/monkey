...
import 'package:monkey/bloc/login_bloc/login_bloc.dart';
...
class LoginScreen extends StatelessWidget {
        ...
        child: Form(
          ...
          child: Column(
            children: [
              ...
              20.heightBox,
              AppText(
                text: AppStrings.ADD_YOUR_DETAIL_SIGNUP,
                color: kBlack12,
  ...
  Row buildSignupText(BuildContext context) {
    return Row(
      ...
      children: [
        ...
        AppTextButton(
            onPressed: () => navigateAndFinish(context, SignupScreen()),
            child: AppText(
  ...
  AppButton buildLogin() => AppButton(
        onPress: () {
          if (_formKey.currentState!.validate()) {
            loginBloc.add(LoginEventFetch(loginModel: LoginModel(username: _mobileController.text, password: _passwordController.text)));
          }
        },
        text: AppStrings.LOGIN,
      );
